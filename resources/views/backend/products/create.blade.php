            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('backend.products.store') }}" method="POST" id="product-create-form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('main_image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Upload a main product image (JPG, PNG, WEBP).</div>
                                </div>
