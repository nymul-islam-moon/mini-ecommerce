                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('backend.sub-categories.store') }}" method="POST">
                            ...
                            <!-- Status -->
                            <div class="mb-3">
                                <label for="is_active" class="form-label">Select Status <span class="text-danger">*</span></label>
                                <select name="is_active" id="category_status" class="form-select @error('is_active') is-invalid @enderror" required>
...
$(document).ready(function() {
    ...
    $('#category_status').select2({
        theme: 'bootstrap4', // use bootstrap4 theme for proper layer display
    ...
    function initCategorySelect2() {
        ...
        $select.select2({
            theme: 'bootstrap4', // ensures dropdown layer displays correctly
